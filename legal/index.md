...
You are granted a non-exclusive, non-transferable right to use the application. The source code, design, and assets are the intellectual property of the developer.

#### 3. Camera Usage

The 'Scanner' feature uses your device's camera exclusively to detect the colors of the cube state in real-time. Image processing is performed entirely locally on your device. No images or video feeds are transmitted to any external server.

#### 4. Liability

The developer assumes no liability for damages resulting from the use of the application, including but not limited to battery drain or incorrect algorithm suggestions.
...
nicolas.freitag@qube-db.com

#### Disclaimer

The contents of this application have been created with the utmost care. However, we cannot guarantee the contents' accuracy, completeness, or topicality.
...
QubeDB ist ein Werkzeug zur Unterstützung beim Lösen und Trainieren des Zauberwürfels und bietet sowohl kostenlose als auch kostenpflichtige Funktionen. Die Anwendung wird 'wie besehen' für den persönlichen Gebrauch bereitgestellt.

#### 2. Nutzungsrechte

Ihnen wird ein nicht-exklusives, nicht übertragbares Recht zur Nutzung der Anwendung eingeräumt. Der Quellcode, das Design und die Assets sind geistiges Eigentum des Entwicklers.

#### 3. Kameranutzung

Die 'Scanner'-Funktion nutzt die Kamera Ihres Geräts ausschließlich, um die Farben des Würfelzustands in Echtzeit zu erkennen. Die Bildverarbeitung erfolgt vollständig lokal auf Ihrem Gerät. Es werden keine Bilder oder Video-Feeds an externe Server übertragen.

#### 4. Haftung

Der Entwickler übernimmt keine Haftung für Schäden, die aus der Nutzung der Anwendung resultieren, einschließlich, aber nicht beschränkt auf Batterieverbrauch oder fehlerhafte Algorithmusvorschläge.
